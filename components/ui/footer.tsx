        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="text-gray-400 font-medium mb-1">Biashara Plaza</li>
                  <li className="text-gray-400 font-medium mb-1">Suite No.10, Ground Floor</li>
                  <li className="text-gray-400 font-medium mb-1">Tel:</li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="text-gray-400 text-sm mr-4">
              &copy; Made by MegDev. All rights reserved.
            </div>
          </div>
        </div>
      </div>
